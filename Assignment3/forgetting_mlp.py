...
# Depth ablation (keep dropout=0.5, opt=adam, loss=nll)
print("\n=== Depth Ablation ===")
ACC_d2, BWT_d2, R_d2 = run_variant(2, DROPOUT_RATE, "adam", "nll", 0.0, 0.0)
ACC_d4, BWT_d4, R_d4 = run_variant(4, DROPOUT_RATE, "adam", "nll", 0.0, 0.0)
results.append(("Depth 2", 2, DROPOUT_RATE, "adam", "nll", 0.0, 0.0, ACC_d2, BWT_d2, R_d2))
results.append(("Depth 4", 4, DROPOUT_RATE, "adam", "nll", 0.0, 0.0, ACC_d4, BWT_d4, R_d4))
