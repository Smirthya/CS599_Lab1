...
results.append(("Task C.1", DEPTH, DROPOUT_RATE, "adam", "l1", 1e-5, 0.0, ACC_l1, BWT_l1, R_l1))
results.append(("Task C.2", DEPTH, DROPOUT_RATE, "adam", "l2", 0.0, 1e-4, ACC_l2, BWT_l2, R_l2))
results.append(("Task C.3", DEPTH, DROPOUT_RATE, "adam", "l1+l2", 1e-5, 1e-4, ACC_l12, BWT_l12, R_l12))
...
results.append(("Task D.1", DEPTH, DROPOUT_RATE, "sgd", "nll", 0.0, 0.0, ACC_sgd, BWT_sgd, R_sgd))
results.append(("Task D.2", DEPTH, DROPOUT_RATE, "rmsprop", "nll", 0.0, 0.0, ACC_rms, BWT_rms, R_rms))
